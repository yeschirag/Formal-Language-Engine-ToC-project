...
const TargetCursor = ({
  ...
  const moveCursor = useCallback((x, y) => {
    ...
    window.dispatchEvent(new CustomEvent('target-cursor-move', { detail: { x, y } }));
  }, []);
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      cursorHideStyleEl = document.createElement('style');
      cursorHideStyleEl.setAttribute('data-target-cursor-hide', 'true');
      cursorHideStyleEl.textContent = 'html, body, body * { cursor: none !important; }';
      document.head.appendChild(cursorHideStyleEl);
    }
    ...
    return () => {
      ...
      spinTl.current?.kill();
      if (cursorHideStyleEl?.parentNode) {
        cursorHideStyleEl.parentNode.removeChild(cursorHideStyleEl);
      }
